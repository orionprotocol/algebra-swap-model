...
class FullMath {
    static mulDiv(a, b, denominator) {
        ...
        const mm = (a * b) % ethers_1.MaxUint256; // Most significant 256 bits of the product
        let prod1 = mm - prod0;
        if (mm < prod0) {
            prod1 -= 1n;
        }
        ...
        else if (twos == ethers_1.MaxUint256) {
            twos = 0n;
        }
        else {
            twos = (ethers_1.MaxUint256 + 1n - twos) / twos + 1n;
        }
        prod0 |= prod1 * twos;
