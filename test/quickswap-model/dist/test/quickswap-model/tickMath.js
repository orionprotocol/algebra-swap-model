...
exports.TickMath = exports.MAX_SQRT_RATIO = exports.MIN_SQRT_RATIO = exports.MAX_TICK = exports.MIN_TICK = void 0;
const assert_1 = __importDefault(require("assert"));
exports.MIN_TICK = -887272n;
...
class TickMath {
    ...
    static getTickAtSqrtRatio(price) {
        // second inequality must be < because the price can never reach the price at the max tick
        (0, assert_1.default)(price >= exports.MIN_SQRT_RATIO && price < exports.MAX_SQRT_RATIO);
